...
/**
 * Minimal browser PlatformSupport. The game renders text through bundled
 * BitmapText fonts (font*.png), so the FreeType hooks are inert.
 */
public class WebPlatformSupport extends PlatformSupport {
	...
	@Override public String[] splitforTextBlock( String text, boolean multiline ) {
