...
/**
 * Game entry point, ported from the original Android Activity to the
 * platform-agnostic noosa-gdx {@link Game}. Backend launchers (:android,
 * :desktop, :web) instantiate this class with their PlatformSupport.
 *
 * Android-specific behaviours of the original (immersive mode, orientation
 * switching) became no-ops at this layer; they belong to the platform
 * launchers now. The preference keys are kept so old settings carry over.
 */
public class PixelDungeon extends Game {

	public PixelDungeon( PlatformSupport platform ) {
		super( TitleScene.class, platform );
	...
	public void create() {
		...
		Sample.INSTANCE.load( new String[] {
			Assets.SND_CLICK,
			Assets.SND_BADGE,
			Assets.SND_GOLD,
	...
	public static void landscape( boolean value ) {
		// Orientation switching is a platform concern now; we only persist the
		// preference so the Android launcher can honour it.
	...
	public static void immerse( boolean value ) {
		// Fullscreen / immersive is a platform concern now; persisted only.
