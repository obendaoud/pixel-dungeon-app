...
/** Void Reach boss arena (Act III, depth 75). Hosts {@code TheEater}. */
public class VoidReachBossLevel extends BossArenaLevel {
	{
	...
	protected boolean[] water() { return Patch.generate( 0.20f, 5 ); }
	protected boolean[] grass() { return Patch.generate( 0.08f, 3 ); }

	@Override public String tileName( int tile ) {
		if (tile == Terrain.WATER) return "Pool of nothing";
