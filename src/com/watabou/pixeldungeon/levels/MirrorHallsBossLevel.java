...
/** Mirror Halls boss arena (Act III, depth 55). Hosts {@code MirrorSelf}. */
public class MirrorHallsBossLevel extends BossArenaLevel {
	{
		color1 = 0x3a4456;
		color2 = 0xc6cdd8;
		viewDistance = 6;
	...
	@Override public String tileName( int tile ) {
		if (tile == Terrain.WATER) return "Quicksilver pool";
