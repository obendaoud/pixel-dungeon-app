...
/** Echo Chambers regular level (Act III, depths 66-69). Caves tileset placeholder. */
public class EchoChambersLevel extends RegularLevel {
	{
	...
	@Override public String tileName( int tile ) {
		switch (tile) {
		case Terrain.WATER: return "Pool of resonance";
		case Terrain.HIGH_GRASS: return "Curtain of sound-dampening fronds";
	...
	@Override public String tileDesc( int tile ) {
		...
		case Terrain.WALL_DECO:
			return "The wall here hums faintly. Sound enters but does not leave.";
